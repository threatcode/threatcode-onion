...
import os
from threatcode.tools import getAllSubclasses, getClassDict
from .base import ThreatcodeModifier

def getModifierList():
    """Return list of modifier classes"""
    path = os.path.dirname(__file__)
    return getAllSubclasses(path, "parser.modifiers", ThreatcodeModifier)
...
def apply_modifiers(value, modifier_list):
    ...
    value: value from Threatcode rule
