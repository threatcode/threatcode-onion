...
class QRadarBackend(SingleTextQueryBackend):
    """Converts Threatcode rule into Qradar saved search. Contributed by SOC Prime. https://socprime.com"""
    identifier = "qradar"
    active = True
    ...
    def generateMapItemTypedNode(self, fieldname, value):
        if type(value) == ThreatcodeRegularExpressionModifier:
            regex = str(value)
    ...
    def generateQuery(self, parsed, threatcodeparser):
        ...
        self.parsedlogsource = threatcodeparser.get_logsource().index
        ...
        try:
            timeframe = threatcodeparser.parsedyaml['detection']['timeframe']
        except:
            timeframe = None
