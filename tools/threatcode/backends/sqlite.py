...
from threatcode.backends.sql import SQLBackend
from threatcode.parser.condition import NodeSubexpression, ConditionAND, ConditionOR, ConditionNOT
import re


class SQLiteBackend(SQLBackend):
    """Converts Threatcode rule into SQL query for SQLite"""
    identifier = "sqlite"
    active = True
    ...
    def __init__(self, threatcodeconfig, table):
        super().__init__(threatcodeconfig, table)
