...
from ..parser.modifiers.transform import ThreatcodeContainsModifier, ThreatcodeStartswithModifier, ThreatcodeEndswithModifier
from ..parser.modifiers.type import ThreatcodeRegularExpressionModifier
...
class WindowsDefenderATPBackend(SingleTextQueryBackend):
    """Converts Threatcode rule into Microsoft Defender ATP Hunting Queries."""
    identifier = "mdatp"
    active = True
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fieldMappings = {       # mapping between Threatcode and ATP field names
            # Supported values:
    ...
    def generateBefore(self, parsed):
        if not any(self.tables):
            raise NotSupportedError("No MDATP table could be determined from Threatcode rule")
