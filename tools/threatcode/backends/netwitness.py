# NetWitness output backend for threatcodec
...
class NetWitnessBackend(SingleTextQueryBackend):
    """Converts Threatcode rule into NetWitness saved search. Contributed by @tuckner"""
    ...
    def generate(self, threatcodeparser):
        ...
        for k in threatcodeparser.parsedyaml["detection"].keys():
