...
* threatcode2attack tool

### Changed

* Improved usage of keyword fields for Elasticsearch-based backends
* Splunk XML backend rule titles from threatcode rule instead of file name
...
* Kibana object id is now Threatcode rule id if available. Else
  the old naming scheme is used.
* threatcode2misp: replacement of deprecated method usage.
...
* threatcode-uuid tool for addition and check of Threatcode rule identifiers
* Default configurations
* Restriction of compared rules in threatcode-similarity
