...
so-elastic-agent:
  docker_container.running:
    ...
    - port_bindings:
      ...
      {% endfor %}
    - binds:
      - /opt/tc/conf/elastic-agent/elastic-agent.yml:/usr/share/elastic-agent/elastic-agent.yml:ro
      - /opt/tc/log/elasticagent:/usr/share/elastic-agent/logs
      - /etc/pki/tls/certs/intca.crt:/etc/pki/tls/certs/intca.crt:ro 
      - /nsm:/nsm:ro
      - /opt/tc/log:/opt/tc/log:ro
