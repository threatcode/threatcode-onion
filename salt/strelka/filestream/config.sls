...
filestream_config:
  file.managed:
    - name: /opt/tc/conf/strelka/filestream/filestream.yaml
...
install_watchdog:
  pkg.installed:
    - name: threatcode-python39-watchdog
{% endif %}
...
filecheck.log:
  file.managed:
    - name: /opt/tc/log/strelka/filecheck.log
    - user: {{ filecheck_runas }}
    - group: {{ filecheck_runas }}

filecheck_stdout.log:
  file.managed:
    - name: /opt/tc/log/strelka/filecheck_stdout.log
    - user: {{ filecheck_runas }}
    - group: {{ filecheck_runas }}
