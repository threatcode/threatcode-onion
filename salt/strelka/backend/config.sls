...
backend_backend_config:
  file.managed:
    - name: /opt/tc/conf/strelka/backend/backend.yaml
...
backend_logging_config:
  file.managed:
    - name: /opt/tc/conf/strelka/backend/logging.yaml
...
backend_passwords:
  file.managed:
    - name: /opt/tc/conf/strelka/backend/passwords.dat
...
backend_taste:
  file.managed:
    - name: /opt/tc/conf/strelka/backend/taste/taste.yara
